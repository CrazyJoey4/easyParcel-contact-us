<template>
    <div class="cust row">
        <div class="col-md-12">
            <h4 class="mb-0">General Enquiry/Feedback</h4>
            <hr>
            <form class="form-horizontal" @submit.prevent="submitForm">
                ...
                <div class="form-group">
                    <label class="col-sm-3 nott">Name<span class="text-danger">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" class="sm-form-control" value="" name="Customer_Name" placeholder="Your Name">
                        <div class="err_msg" style="color:#F00;">{{ nameError }}</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 nott">Registered Email Address<span class="text-danger">*</span></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-3 nott">Question/Comment<span class="text-danger">*</span></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="contactform_dropzone dropzone dz-clickable" id="cust_attachment">
...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            const name = this.$el.querySelector('input[name="Customer_Name"]').value;
            ...
            if (!name.trim()) {
                this.nameError = 'You must entered your name.';
            }
            ...
            if (this.titleError || this.nameError || this.emailError || this.commentError) {
                return;
            }

            console.log('Form submitted:', { title, name, email, comment });
            ...
            this.simulateServerProcessing(title, name, email, comment);
        },

        simulateServerProcessing(title, name, email, comment) {
            // Simulate sending email
            console.log('Simulating server processing:', { title, name, email, comment });
